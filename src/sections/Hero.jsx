    ...
    return(
        <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                {
                    [...Array(30)].map((_,i)=>(
                        <div className="w-1.5 h-1.5 rounded-full bg-primary/35 absolute opacity-60"
                        style={{
            ...
            <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-muted-foreground md:text-lg max-w-lg animate-fade-in animation-delay-200">
                                I'm Sheevan Ul Haq, an MCA student at NIT Bhopal with a strong interest in software development, data structures & algorithms, and web technologies. I enjoy building projects, solving coding challenges, and continuously learning new technologies to create impactful digital solutions.
                            </p>
                        </div>
                        {/* CTA's */}
                        ...
                        <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
                            <span className="text-sm text-muted-foreground">Follow me: </span>
                            {
                                [
                                    ...
                                    { icon: FaLinkedin, href: "https://www.linkedin.com/in/sheevanulhaq/" },
                                    { icon: FaInstagram, href: "https://www.instagram.com/sheevan_ul_haq/" },
                                    ].map((social, idx) => (
                                    <a
                                        href={social.href}
                                        key={idx}
                    ...
                    <div className="relative animate-fade-in animation-delay-300">
                        ...
                        <div className="relative max-w-md mx-auto">
                            <div className="relative glass rounded-3xl p-2 glow-border">
                                <img src="/professional-profile.png" alt="Sheevan Ul Haq" className="w-full aspect-4/5 object-cover rounded-2xl"/>
                                {/* Floating Badge */}
                                ...
                                <div className="hidden absolute -top-4 -left-6 glass px-4 py-3 rounded-xl animate-float animation-delay-500">
                                    ...
                                    <div className="italic text-xs text-muted-foreground">Years Exp.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="relative mt-20 animate-fade-in animation-delay-600">
                    <p className="text-sm text-muted-foreground text-center mb-5">Technologies I work with</p>
                    <div className="overflow-hidden">
                        <div className="flex w-max animate-marquee">
                            {[...skills, ...skills].map((skill, idx) => (
                            <span
                                key={idx}
                                className="shrink-0 px-4 text-2xl text-muted-foreground"
                            >
                                {skill}
                            </span>
                            ))}
